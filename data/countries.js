...
const countries = {
    ...
    fairy: {
        type: "fairy",  // 👈 AJOUTÉ (pour actions spécifiques)
        name: "🧚 Fée",
    ...
    vampire: {
        type: "vampire",  // 👈 AJOUTÉ (pour actions spécifiques)
        name: "🧛 Vampire",
    ...
    elf: {
        type: "elf",  // 👈 AJOUTÉ (pour actions spécifiques)
        name: "🧝 Elfe",
    ...
    darkelf: {
        type: "elf",  // 👈 AJOUTÉ (même type que elfe)
        name: "⚡ Elfe Noir",
    ...
    // ==================== SUPER-HÉROS (4) ====================
    marvelreal: {
        type: "superman",  // 👈 AJOUTÉ (pour actions super-héros)
        name: "🦸 Marvel",
    ...
    // ==================== MYTHOLOGIE (2) ====================
    athena: {
        type: "athena",  // 👈 AJOUTÉ (pour actions spécifiques)
        name: "🦸 Athéna",
    ...
    cowgirl: {
        type: "cowgirl",  // 👈 AJOUTÉ (pour actions spécifiques)
        name: "🤠 Cowgirl",
        dance: "Danse Country",
    ...
    pirate: {
        type: "pirate",  // 👈 AJOUTÉ (pour actions spécifiques)
        name: "🏴‍☠️ Pirate",
    ...
    princess: {
        type: "princess",  // 👈 AJOUTÉ (pour actions spécifiques)
        name: "👸 Princesse",
        dance: "Danse de Cour",
    ...
    siren: {
        type: "siren",  // 👈 AJOUTÉ (pour actions spécifiques)
        name: "🧜 Sirène",
    ...
    // ==================== PRÉHISTORIQUE (1) ====================
    cavewoman: {
        type: "cavewoman",  // 👈 AJOUTÉ (pour actions spécifiques)
    ...
    spacecowgirl: {
        type: "cowgirl",  // 👈 AJOUTÉ (comme cowgirl)
